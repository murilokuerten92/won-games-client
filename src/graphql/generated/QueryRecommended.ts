...
export interface QueryRecommended_recommended_data_attributes_section_highlight_background_data {
  ...
  attributes: QueryRecommended_recommended_data_attributes_section_highlight_background_data_attributes;
}

export interface QueryRecommended_recommended_data_attributes_section_highlight_background {
  __typename: "UploadFileEntityResponse";
  data: QueryRecommended_recommended_data_attributes_section_highlight_background_data;
}
...
export interface QueryRecommended_recommended_data_attributes_section_highlight_floatImage_data {
  __typename: "UploadFileEntity";
  attributes: QueryRecommended_recommended_data_attributes_section_highlight_floatImage_data_attributes;
}

export interface QueryRecommended_recommended_data_attributes_section_highlight_floatImage {
  __typename: "UploadFileEntityResponse";
  data: QueryRecommended_recommended_data_attributes_section_highlight_floatImage_data;
}
...
export interface QueryRecommended_recommended_data_attributes_section_highlight {
  ...
  floatImage: QueryRecommended_recommended_data_attributes_section_highlight_floatImage;
  buttonLabel: string;
  buttonLink: string;
...
export interface QueryRecommended_recommended_data_attributes_section_games_data_attributes_cover_data {
  __typename: "UploadFileEntity";
  attributes: QueryRecommended_recommended_data_attributes_section_games_data_attributes_cover_data_attributes;
}

export interface QueryRecommended_recommended_data_attributes_section_games_data_attributes_cover {
  __typename: "UploadFileEntityResponse";
  data: QueryRecommended_recommended_data_attributes_section_games_data_attributes_cover_data;
}
...
export interface QueryRecommended_recommended_data_attributes_section_games_data_attributes_developers_data {
  ...
  attributes: QueryRecommended_recommended_data_attributes_section_games_data_attributes_developers_data_attributes;
}
...
export interface QueryRecommended_recommended_data_attributes_section_games_data_attributes {
  ...
  name: string;
  slug: string;
  cover: QueryRecommended_recommended_data_attributes_section_games_data_attributes_cover;
  developers: QueryRecommended_recommended_data_attributes_section_games_data_attributes_developers;
  price: number;
}

export interface QueryRecommended_recommended_data_attributes_section_games_data {
  __typename: "GameEntity";
  attributes: QueryRecommended_recommended_data_attributes_section_games_data_attributes;
}
...
export interface QueryRecommended_recommended_data_attributes_section {
  ...
  title: string;
  highlight: QueryRecommended_recommended_data_attributes_section_highlight;
  games: QueryRecommended_recommended_data_attributes_section_games;
}
...
export interface QueryRecommended_recommended_data {
  ...
  attributes: QueryRecommended_recommended_data_attributes;
}

export interface QueryRecommended_recommended {
  __typename: "RecommendedEntityResponse";
  data: QueryRecommended_recommended_data;
}
